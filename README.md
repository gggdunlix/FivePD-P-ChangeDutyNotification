...
2. Go to the fivepd `config.json` and set the `"dutyNotification":` to `false` ![image](https://github.com/gggdunlix/FivePD-P-ChangeDutyNotification/assets/33298379/cdd42a96-9903-48ec-87f7-108d2c10c129)
